...
def setup_test(
    app_context, mock_server, max_score_distance=None, min_score_distance=None
):
...
def test_call_with_max_distance(
    ...
    # Arrange
    mock_similar_documents, inputs, chain = setup_test(
        app_context, mock_server, max_score_distance=0.5
    )
    similarity_search_with_score.return_value = mock_similar_documents
    ...
    post_filter_call_arg = similarity_search_with_score.call_args[1][
...
def test_call_with_min_distance(
    ...
    # Arrange
    mock_similar_documents, inputs, chain = setup_test(
        app_context, mock_server, min_score_distance=0.5
    )
    similarity_search_with_score.return_value = mock_similar_documents
